        ...
        <>
            <div className="w-[80%] flex flex-col justify-center items-center text-black font-poppins py-3 mb-7 animate-popup">
                <div className="flex flex-col items-center mb-5 gap-3">
                    ...
                    <span className="text-black font-bold font-poppins text-2xl">Change Password</span>
                    <span className="text-black/40 font-poppins font-extralight text-sm">Change Password Successfully</span>
